...
export default function HomePage() {
  ...
  return (
    <main className="relative w-screen h-screen mx-auto flex flex-col justify-between" style={{ backgroundImage: `url(${ClassroomImg.src})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
      ...
      <div className="w-full h-[1200px] flex justify-center items-end pb-15">
        <div className="grid grid-cols-5 gap-x-8 gap-y-12 -ml-2 ">
          {[
            { img: Classmate1Img, name: "白苡詰" },
            { img: Classmate2Img, name: "何慕昀" },
            { img: Classmate3Img, name: "許雅喬" },
            { img: Classmate4Img, name: "洪安旭" },
            { img: Classmate5Img, name: "毛怡蓁" },
            { img: Classmate6Img, name: "王巧薰" },
            { img: Classmate7Img, name: "何羽凡" },
            { img: Classmate8Img, name: "黃梓育" },
            { img: Classmate9Img, name: "張育涵" },
            { img: Classmate10Img, name: "謝雨彤" },
          ].map((student, index) => (
            <div key={index} className="relative w-[120px] h-[180px] flex flex-col items-center justify-center group">
              <div className="relative">
                ...
                />
                <button
                  onClick={() => console.log(`${student.name} 進入遊戲！`)}
